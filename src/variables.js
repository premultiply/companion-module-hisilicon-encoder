export function setVariables(self) {
	const variables = [
		...
		{ variableId: 'vi_venc0_rtmp_url', name: 'Video Encoder 1: RTMP Push URL' },
		{ variableId: 'vi_venc0_rtmp_status', name: 'Video Encoder 1: RTMP Push Status' },
		{ variableId: 'vi_venc0_srt_url', name: 'Video Encoder 1: SRT Caller URL' },
		...
		{ variableId: 'vi_venc1_rtmp_url', name: 'Video Encoder 2: RTMP Push URL' },
		{ variableId: 'vi_venc1_rtmp_status', name: 'Video Encoder 2: RTMP Push Status' },
		{ variableId: 'vi_venc1_srt_url', name: 'Video Encoder 2: SRT Caller URL' },
		...
		{ variableId: 'vi_venc2_rtmp_url', name: 'Video Encoder 3: RTMP Push URL' },
		{ variableId: 'vi_venc2_rtmp_status', name: 'Video Encoder 3: RTMP Push Status' },
		{ variableId: 'vi_venc2_srt_url', name: 'Video Encoder 3: SRT Caller URL' },
		...
		{ variableId: 'vi_venc3_rtmp_url', name: 'Video Encoder 4: RTMP Push URL' },
		{ variableId: 'vi_venc3_rtmp_status', name: 'Video Encoder 4: RTMP Push Status' },
		{ variableId: 'vi_venc3_srt_url', name: 'Video Encoder 4: SRT Caller URL' },
...
export function checkVariables(self) {
	self.setVariableValues({
		...
		ai_samplerate: self.data.ai.samplerate ? self.data.ai.samplerate : self.data.aisamplerate,
		...
		vi_venc0_codec: self.data.vi.venc[0].codec,
		vi_venc0_bitrate: self.data.vi.venc[0].bitrate,
		vi_venc0_rtmp_url: self.data.vi.venc[0].rtmp_publish_url,
		vi_venc0_rtmp_status: self.data.vi.venc[0].rtmp_status,
		vi_venc0_srt_url: self.data.vi.venc[0].srt_publish_url0,
		vi_venc0_srt_status: self.data.vi.venc[0].srt_status,
		vi_venc1_codec: self.data.vi.venc[1].codec,
		vi_venc1_bitrate: self.data.vi.venc[1].bitrate,
		vi_venc1_rtmp_url: self.data.vi.venc[1].rtmp_publish_url,
		vi_venc1_rtmp_status: self.data.vi.venc[1].rtmp_status,
		vi_venc1_srt_url: self.data.vi.venc[1].srt_publish_url0,
		vi_venc1_srt_status: self.data.vi.venc[1].srt_status,
		vi_venc2_codec: self.data.vi.venc[2].codec,
		vi_venc2_bitrate: self.data.vi.venc[2].bitrate,
		vi_venc2_rtmp_url: self.data.vi.venc[2].rtmp_publish_url,
		vi_venc2_rtmp_status: self.data.vi.venc[2].rtmp_status,
		vi_venc2_srt_url: self.data.vi.venc[2].srt_publish_url0,
		vi_venc3_codec: self.data.vi.venc[3].codec,
		vi_venc3_bitrate: self.data.vi.venc[3].bitrate,
		vi_venc3_rtmp_url: self.data.vi.venc[3].rtmp_publish_url,
		vi_venc3_rtmp_status: self.data.vi.venc[3].rtmp_status,
		vi_venc3_srt_url: self.data.vi.venc[3].srt_publish_url0,
		vi_venc3_srt_status: self.data.vi.venc[3].srt_status,
